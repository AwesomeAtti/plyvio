<script>
  /**
   * Lichess source mark — §3.2.3.3.
   *
   * Path from Simple Icons (CC0 1.0), the knight mark, which is Lichess’s identity in full.
   * CC0 covers the artwork data; the mark itself remains Lichess’s trademark.
   *
