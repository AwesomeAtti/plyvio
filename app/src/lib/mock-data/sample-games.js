 ...
 *
 * ROWS 31-70 COME FROM ONE CURATED FILE, `samples/pgn/sample-games.pgn` — ten
 ...
 * same as the corpus below — an unplanned but welcome find, not something this file went
 * looking for.
 *
 ...
 * Together with row 1 and the ten GothamChess-vs-AwesomeAtti rows above, THIRTY-SIX rows in
 * the whole table carry engine annotation; the other THIRTY do not.
 *
